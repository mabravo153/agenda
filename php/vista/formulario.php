...
<div class="campo-contacto">
    ...
    <input type="text" name="idEmpresa" id="idEmpresa" placeholder="Tu Documento">            
</div>
<div class="campo-contacto">
...
<div class="campo-contacto" id="empresa">
    ...
    <input type="text" name="empresa" id="empresaNombre" placeholder="Tu Empresa">
</div>
<div class="campo-contacto" id="telefono">
    <label for="telefono">Telefono</label>
    <input type="tel" name="telefono" id="telefonoEmpresa" placeholder="Tu Telefono">
</div>
